    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" action="{{ route('admin.room.update',$room->id) }}" method="post" enctype="multipart/form-data" >
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="count" class="form-control" id="" value="{{$room->count}}"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="">Room Price</label>
                            <input type="text" name="price" class="form-control" id="" value="{{$room->price}}"
                                placeholder="">
                        </div>
                        <div class="form-group">
